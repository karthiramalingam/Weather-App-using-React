...
import windhIcon from "./assets/windy.png";
...
const WeatherDetails=({icon,temp,city,country,lat,log,wind,humidity})=>{
 return (
  <>
  <div className="image">
   <img src={icon} alt="Image"  className="serach-src"/>
  </div>
  ...
  <div className="data-container">
    ...
    <div className="element">
      <img src={windhIcon} alt="Wind" className="icon"/>
      <div className="data">
...
export const App1 = () => {
  let api_key="790fa462ea2f63f6f118d12dd2c4897d";
  ...
  return (
    ...
    <div className="container">
      ...
      <div className="search-icon" onClick={()=>search()}>
        <img src={searchIcon} alt="Search" className="searchic"/> 
      </div>
      </div>
      
      {loading&&<div className="loading-message">Loading...</div>}
      {error && <div className="error-message">{error}</div>}
      {cityNotFound && <div className="city-not-fount">City not found</div>}
